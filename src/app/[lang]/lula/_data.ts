...
export const THREE_REASONS: BigCoNotDo[] = [
  ...
  {
    title: '品牌不能贴',
    desc: '京东自营 / 华为 / 字节豆包的 logo 印上去要担社会责任和审美包袱，方言 + 老 IP + 直白功能命名这套打法先被法务和品牌部毙掉',
  },
  {
    title: '渠道下不去',
...
export const LOW_PATHS: LowPath[] = [
  ...
  {
    num: '03',
    title: '命名直白 · 功能优先 + 老 IP 借力',
    desc: '不要 BubblePal / CocoMate / 芙崽 这种英文 + 二次元名字。功能即名字 + 老 IP 联名，才是县城妈妈在母婴店货架上 3 秒就能看懂的语言',
    examples: [
      '❌ "BubblePal" / "芙崽" / "智能憨憨"',
      '✅ 讲故事熊 / 哄饭小狗 / 学拼音猫 / 接娃小老虎',
      '✅ 奥特曼讲故事机 / 喜羊羊学拼音 / 熊出没哄饭神器',
    ],
    whyMoat: '"讲故事熊 / 哄饭小狗"这种直白功能命名,大厂品牌部立项会上过不了——这就是壁垒',
  },
  {
    num: '04',
    ...
    whyMoat: '大厂硬件最低毛利门槛 35%+、SKU 出货 50 万台起、品牌不肯贴县城——¥149 价位段 + 县代理渠道这两件事大厂三个都过不了',
  },
];
